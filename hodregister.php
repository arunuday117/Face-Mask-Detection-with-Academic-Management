...
if(isset($_POST['register']))
{
    ...
    if(empty($hodof))
    {
        $error_msg['hodof']="**Head Of Department is required";
        $flag=1;
    }
    if(empty($password))
    {        
    ...
    {	
        ...
        {
            $error_msg['first_name']="*Invalid first name"; 
            $flag=1;                  
        }
        if (!preg_match('/^[a-zA-Z]*$/',$last_name))
        {
            $error_msg['last_name']="*Invalid last name";
            $flag=1;
        }
    ...
    if($flag==0)
    {
        ...
        {
            $sql="INSERT INTO `departmentreg`VALUES ('$did','$first_name','$last_name','$email','$housename','$street','$district','$state','$pin','$phone','$qualification','$experience','$published','$hodof','NULL')";
            if(mysql_query($sql,$con))
            {
                $sql1="INSERT INTO `login`VALUES ('$email','$pass','hod',0,'','')";
          ...
          <div class="right-content">
            ...
            <form id="contact" action="" method="post">
              <div class="row">
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="last_name" type="text" class="form-control" id="name" placeholder="Last Name" required value="<?php if(isset($last_name)){echo $last_name;}  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="email" type="email" class="form-control" id="email" placeholder=" Email ID" required value="<?php if(isset($email)){echo $email;}  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="housename" type="text" class="form-control" id="housename" placeholder="House Name" required value="<?php if(isset($housename)){echo $housename;}  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="street" type="text" class="form-control" id="street" placeholder="Street Name" required value="<?php if(isset($street)){echo $street;}  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="district" type="text" class="form-control" id="district" placeholder="District" required value="<?php if(isset($district)){echo $district;}  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="state" type="text" class="form-control" id="state" placeholder="State" required value="<?php if(isset($state)){echo $state;}  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="pincode" type="text" class="form-control" id="pincode" placeholder="Pincode" required value="<?php if(isset($pin)){echo $pin;}  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="phone" type="text" class="form-control" required id="phone-number" placeholder="Your Phone Number"value="<?php if(isset($phone)){echo $phone;}  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="qualification" type="text" class="form-control" id="qualification" placeholder="Qualification" required value="<?php if(isset($qualification)){echo $qualification;}  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="experience" type="text" class="form-control" id="experience" placeholder="Years of Experience" required value="<?php if(isset($experience)){echo $experience;}  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <textarea name="published" type="text" class="form-control" id="published" placeholder="Papers Published" required value="<?php if(isset($published)){echo $published;}  ?>"></textarea>
                  </fieldset>
                </div>  
                <div class="col-md-12">
                  <fieldset>
                    <select id="select"name="hodof" required>
                ...
                <?php
                    if(isset($error_msg['hodof']))
                    {
                        echo "<font color=red >".$error_msg['hodof']."</font>";
                    }
                    ?>
                <div class="col-md-12">
                  <fieldset>
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="cpassword" type="text" required class="form-control" id="cpassword" placeholder="Confirm Password">
                  </fieldset>
                </div>
                <div class="col-md-12">
                  <fieldset>
