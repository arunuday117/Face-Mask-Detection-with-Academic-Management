...
<body>
 ...
 ?>
  ...
  <div class="main">
    ...
    <div class="course">
      <div class="heading">
            <h6>Download Assignment Marklist</h6>
        </div>
         <?php
      ...
      ?>
      <div class="hide" id='1'>
      <form  method="POST" action="download.php"id="course">
        <input type="text" name="course" value="<?php echo$course; ?>" readonly id="name">
        ...
        <button type="submit" id="submit" name="add">DOWNLOAD</button>
      </form>
    </div>
    <div class="hide" id='2'>
      <form  method="POST" action="download.php"id="course">
  ...
  <!-- Bootstrap core JavaScript -->
    ...
    <script>
      if ( window.history.replaceState ) {function() {}
