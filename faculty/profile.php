...
if(isset($_POST['update']))
{
    ...
    if($flag==0)
    {
        $sql="UPDATE`departmentreg`SET f_name='$first_name',l_name='$last_name',housename='$housename',street='$street',district='$district',state='$state',pincode='$pin',phone='$phone',qualification='$qualification',yoexperience='$experience',ppublished='$published',course='$hodof' WHERE userid='$username'";
        if(mysql_query($sql,$con))
        {
          ...
          <div class="right-content">
            ...
            <form id="contact" action="" method="post">
              <div class="row">
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="published" type="text" class="form-control" id="published"placeholder="Papers published"value="<?php if($row['ppublished']=='NULL'){echo"No papers published";}else{echo$row['ppublished']; } ?>">
                  </fieldset>
                </div>  
                <div class="col-md-12">
                  <fieldset>
