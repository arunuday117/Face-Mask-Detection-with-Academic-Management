...
<body>
 ...
 ?>
  ...
  <div class="main">
    <div class="bt">
        <a id="bt1" class="btn active">Subject Wise</a>
        <a id="bt2" class="btn">Class Wise</a>
        <a id="bt3" class="btn">Student Wise</a>
      </div>
    <div class="course">
     <div class="hide" id="1">
      <div class="heading">
            <h6>Download Subject Wise Marklist</h6>
        </div>
         <?php
      ...
      <form  method="POST" action="pdf.php"id="course">
        ...
        <?php }?>
           ...
           <input type="text" id="name" name="batch" required placeholder="Enter Year Of batch"> 

           <input type="checkbox" name="previous">View Previous<br>

        <button type="submit" id="submit" name="sub">DOWNLOAD</button>
      </form>
    </div>
    <div class="hide" id="2">
      <div class="heading">
            <h6>Download Class Marklist</h6>
        </div>
      <form  method="POST" action="pdf.php"id="course">
        <input type="hidden" name="course" value="<?php echo$course;?>">
        <select id="select" name="type" required>
        ...
        <button type="submit" id="submit" name="class">DOWNLOAD</button>
      </form>
    </div>
    <div class="hide" id="3">
      <div class="heading">
