...
$sql=mysql_query("SELECT * FROM studentreg WHERE userid='$username'");
...
if(isset($_POST['update']))
{
    ...
    if(empty($whatsappph))
    {
    	$error_msg['whatsappph']="**Whatsapp Number is required";
    	$flag=1;
    }
    if(empty($course))
    {
    ...
    {	
        ...
        if (!preg_match("/^[6-9]\d{9}$/", $whatsappph))
        {
            $error_msg['whatsappph']="*Invalid Whatsapp no";
            $flag=1;
        }
    ...
    if($flag==0)
    {
        $sql="UPDATE`studentreg`SET stfname='$first_name',stlname='$last_name',sthousename='$housename',ststreet='$street',stdistrict='$district',ststate='$state',stpincode='$pin',stphone='$phone',whatsappno='$whatsappph',course='$course',batch='$batch'WHERE userid='$username'";
        if(mysql_query($sql,$con))
        {
          ...
          <div class="right-content">
            ...
            <form id="contact" action="" method="post">
              <div class="row">
                <div class="col-md-12">
                  <fieldset>
                    <input name="first_name" type="text" class="form-control"placeholder="First Name" id="name"value="<?php echo$row['stfname'];  ?>">
                  </fieldset>
                </div>
                    <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="last_name" type="text" class="form-control" id="name" placeholder="Last Name"value="<?php echo$row['stlname'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="housename" type="text" class="form-control" id="housename" placeholder="House Name"value="<?php echo$row['sthousename'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="street" type="text" class="form-control" id="street" placeholder="Street Name"value="<?php echo$row['ststreet'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="district" type="text" class="form-control" id="district" placeholder="District"value="<?php echo$row['stdistrict'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="state" type="text" class="form-control" id="state" placeholder="State"value="<?php echo$row['ststate'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="pincode" type="text" class="form-control" id="pincode" placeholder="Pincode" value="<?php echo$row['stpincode'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="phone" type="text" class="form-control" id="phone-number" placeholder="Your Phone Number"value="<?php echo$row['stphone'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="whatsappph" type="text" class="form-control" id="whatsappph" placeholder="Whatsapp Phone no"value="<?php echo$row['whatsappno'];  ?>">
                  </fieldset>
                </div>
                <?php
                    if(isset($error_msg['whatsappph']))
                    {
                        echo "<font color=red >".$error_msg['whatsappph']."</font>";
                    }
                  	?>
                <div class="col-md-12">
                  <fieldset>
                    <input name="fname" type="text" class="form-control" id="fname" placeholder="Guardian's Name"value="<?php echo$row['fname'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input readonly name="course"placeholder="Your Department" type="text" class="form-control" id="course"value="<?php echo$row['course'];  ?>">
                  </fieldset>
                </div>
                <?php
