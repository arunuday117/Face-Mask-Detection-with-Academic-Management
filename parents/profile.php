...
$sql=mysql_query("SELECT * FROM parentreg WHERE userid='$username'");
...
if(isset($_POST['update']))
{
    ...
    if(empty($stid))
    {
      $error_msg['stid']="**University Reg No is required";
      $flag=1;
    }
    if($flag!=1)
    {	
    ...
    if($flag==0)
    {
        $sql="UPDATE`parentreg`SET pfname='$first_name',plname='$last_name',phousename='$housename',pstreet='$street',pdistrict='$district',pstate='$state',ppincode='$pin',pphone='$phone',stid='$stid'WHERE userid='$username'";
        if(mysql_query($sql,$con))
        {
          ...
          <div class="right-content">
            ...
            <form id="contact" action="" method="post">
              <div class="row">
                <div class="col-md-12">
                  <fieldset>
                    <input name="first_name" type="text" class="form-control"placeholder="First Name" id="name"value="<?php echo$row['pfname'];  ?>">
                  </fieldset>
                </div>
                    <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="last_name" type="text" class="form-control" id="name" placeholder="Last Name"value="<?php echo$row['plname'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="housename" type="text" class="form-control" id="housename" placeholder="House Name"value="<?php echo$row['phousename'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="street" type="text" class="form-control" id="street" placeholder="Street Name"value="<?php echo$row['pstreet'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="district" type="text" class="form-control" id="district" placeholder="District"value="<?php echo$row['pdistrict'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="state" type="text" class="form-control" id="state" placeholder="State"value="<?php echo$row['pstate'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="pincode" type="text" class="form-control" id="pincode" placeholder="Pincode" value="<?php echo$row['ppincode'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="phone" type="text" class="form-control" id="phone-number" placeholder="Your Phone Number"value="<?php echo$row['pphone'];  ?>">
                  </fieldset>
                </div>
                <?php
                    ...
                    <div class="col-md-12">
                  <fieldset>
                    <input readonly name="stid"placeholder="Your Ward's University Reg no." type="text" class="form-control" id="stid"value="<?php echo$row['stid'];  ?>">
                  </fieldset>
                </div>
                <?php
                    if(isset($error_msg['stid']))
                    {
                        echo "<font color=red >".$error_msg['stid']."</font>";
                    }
                    ?>
               </div>
               <div class="col-md-12">
