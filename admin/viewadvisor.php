    ...
    <div class="table">
      ...
      <table>
        <tr id="header">
          ...
          $result = mysql_query("SELECT * FROM departmentreg NATURAL JOIN login WHERE departmentreg.userid=login.userid AND type='advisor' AND status='1'");
