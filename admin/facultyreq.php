...
<body>
  ...
  ?>
  <!-- ***** Table for viewing faculty requests ***** -->

  <div class="cover">
    <div class="table">
        <div class="table-heading">
            <h6>Faculty Requests</h6>
        </div>
         <table >
            <tr id="header">
              <th>Id</th>
              ...
              $result = mysql_query("SELECT * FROM departmentreg NATURAL JOIN login WHERE departmentreg.userid=login.userid AND type='faculty' AND status='0'");
