        ...
        <div class="table-heading">
         ...
         <table>
            ...
            <?php
              ...
              $result = mysql_query("SELECT * FROM departmentreg NATURAL JOIN login WHERE departmentreg.userid=login.userid AND type='advisor' AND status='0'");
