...
if(isset($_POST['register']))
{
    ...
    if($flag==0)
    {
        ...
        {
            $sql="INSERT INTO `departmentreg`VALUES ('$did','$first_name','$last_name','$email','$housename','$street','$district','$state','$pin','$phone','$qualification','$experience','$published','$course','NULL')";
            if(mysql_query($sql,$con))
            {
                $sql="INSERT INTO `login`VALUES ('$email','$pass','faculty',0,'','')";
                if(mysql_query($sql,$con))
                {
          ...
          <div class="right-content">
            ...
            <form id="contact" action="" method="post">
              <div class="row">
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="lname" type="text" class="form-control" id="name" placeholder="Last Name"value="<?php if(isset($last_name)){echo $last_name;}  ?>">
                  </fieldset>
                </div>
                <?php
