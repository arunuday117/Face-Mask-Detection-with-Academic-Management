        ...
        <div class="table-heading">
         ...
         <table >
            <tr id="header">
              ...
              $course=$ro['course'];
              $result = mysql_query("SELECT * FROM departmentreg NATURAL JOIN login WHERE departmentreg.userid=login.userid AND type='advisor'AND course='$course' AND status='1'");
