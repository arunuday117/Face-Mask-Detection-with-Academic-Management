  ...
  <div class="main">
    <div class="course">
      <div class="heading">
        ...
        $batch=$ro['batch'];
      ?>
      <form  method="POST" action="nfetch.php"id="course">
        <select id="select" id="type" name="type" required>
          ...
          <select id="select" id="sem" name="sem" required>
          ...
          <select id="select" id="sub" name="sub" required>
        ...
        <input type="text" class="name" id="batch" name="batch" placeholder="Enter Year Of batch"> 
        <br><br>
