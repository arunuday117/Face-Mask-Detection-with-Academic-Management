  ...
  <div class="main">
    ...
    <div class="course">
      <div class="alerts hides">
         ...
         <span class="msgs">Deletion is avaialable for one day from adding of assignment!</span>
      ...
      <form  method="POST" action=""id="course">
        ...
        <?php }?>
         ...
         <input type="text" name="batch" id="name" placeholder="Enter Year of Batch">
         <?php
      ...
      <div class="heading">
        ...
        <table>
            <tr id="header">
              ...
              include 'includes/dbconnect.php';
              $date=date('Y-m-d');
              $result = mysql_query("SELECT * FROM assignment WHERE did='$did'");
