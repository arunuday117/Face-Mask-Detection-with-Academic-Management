...
if(isset($_POST['update']))
{
    ...
    if($flag==0)
    {
        $sql="UPDATE`departmentreg`SET f_name='$first_name',l_name='$last_name',housename='$housename',street='$street',district='$district',state='$state',pincode='$pin',phone='$phone',qualification='$qualification',yoexperience='$experience',ppublished='$published',course='$hodof',batch='$batch' WHERE userid='$username'";
        if(mysql_query($sql,$con))
        {
          ...
          <div class="right-content">
            ...
            <form id="contact" action="" method="post">
              <div class="row">
                <div class="col-md-12">
                  <fieldset>
                    <input name="first_name" type="text" class="form-control" id="name"value="<?php echo$row['f_name'];  ?>">
                  </fieldset>
                </div>
                    <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="last_name" type="text" class="form-control" id="name" placeholder="Last Name"value="<?php echo$row['l_name'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="housename" type="text" class="form-control" id="housename" placeholder="House Name"value="<?php echo$row['housename'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="street" type="text" class="form-control" id="street" placeholder="Street Name"value="<?php echo$row['street'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="district" type="text" class="form-control" id="district" placeholder="District"value="<?php echo$row['district'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="state" type="text" class="form-control" id="state" placeholder="State"value="<?php echo$row['state'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="pincode" type="text" class="form-control" id="pincode" placeholder="Pincode" value="<?php echo$row['pincode'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="phone" type="text" class="form-control" id="phone-number" placeholder="Your Phone Number"value="<?php echo$row['phone'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="qualification" type="text" class="form-control" id="qualification" placeholder="Qualification"value="<?php echo$row['qualification'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="experience" type="text" class="form-control" id="experience" placeholder="Years of Experience"value="<?php echo$row['yoexperience'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="published" type="text" class="form-control" id="published"placeholder="Papers published"value="<?php if($row['ppublished']==''){echo"No papers published";}else{echo$row['ppublished']; } ?>">
                  </fieldset>
                </div>  
                <div class="col-md-12">
                  <fieldset>
                    <input readonly name="hodof"placeholder="Your Department" type="text" class="form-control" id="hodof"value="<?php echo$row['course'];  ?>">
                  </fieldset>
                </div>
                <?php
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input readonly name="batch"placeholder="Your Batch" type="text" class="form-control" id="batch"value="<?php echo$row['batch'];  ?>">
                  </fieldset>
                </div>
                <?php
