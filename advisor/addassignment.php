  ...
  <div class="main">
    ...
    <div class="course">
      ...
      <form  method="POST" action=""id="course">
          <select id="select" class="sub" name="subject" required>
          <option selected value="">--Select Subject--</option>
          <?php
            $st=mysql_query("SELECT * FROM subject WHERE sbcourse='$course' ORDER BY sbsem ASC");
        ...
        <?php }?>
         ...
         <input type="text" name="batch" id="name" placeholder="Enter Year of Batch eg.(2018-2021)" required>
         <?php
